...
const config = {
  ...
  site_name: 'DASH SANTOSH | Front-End Developer, UI/UX Designer | Personal Portfolio',

  // Your website's description, used for favicon meta tags
  site_description: 'Helping new businessess Expand, and the old ones Adapt to the ever-changing World of Internet, with Modern Web Solutions.',
