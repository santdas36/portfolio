...
const config = {
  ...
  site_name: 'DASH SANTOSH | Front-End Developer, UI/UX Designer | Web Portfolio',

  // Your website's description, used for favicon meta tags
  site_description: 'Helping new businessess Expand, and the old ones Evolve in this avant-garde World of Internet, with Modern Web Solutions.',

  // Your website's URL, used for sitemap
  site_url: 'https://dashsantosh.me',
